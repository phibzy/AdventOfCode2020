...
class test(unittest.TestCase):
    ...
    def testValid(self):
        ...
        # self.assertTrue(checkValid("babbbbaabbbbbabbbbbbaabaaabaaa", self.testInput[3][0], "0", 0)[0])
        pprint(self.testInput[3][0])
        self.assertTrue(checkValid("aaaaabbaabaaaaababaa", self.testInput[3][0], "0", 0)[0])
